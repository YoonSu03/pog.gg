...
var Leauges = function Leauges(_ref) {
  ...
  return __jsx("div", {
    ...
    var matchdata = matchList.matches[i];
    var gamemode = "";
    console.log(matchdata.role);

    if (matchdata.role === "NONE" || matchdata.role === "DUO_SUPPORT") {
      gamemode = "일반게임";
    } else if (matchdata.role === "SOLO") {
      gamemode = "솔로랭크";
    }
...
//# sourceMappingURL=summoner.js.52b2b538c836adca474b.hot-update.js.map