...
function getleagueFirst(encryptedSummonerId) {
  return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(address + "/userleagueFirst", {
    params: {
...
function getleagueSecond(leagueId) {
  return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(address + "/userleagueSecnd", {
    params: {
      leagueId: leagueId
    }
  });
...
//# sourceMappingURL=summoner.js.edbf5b0fd016d621b245.hot-update.js.map