...
var _this = undefined,
    _jsxFileName = "D:\\ReactProject\\javaproject\\lod.gg\\lodgg_frontend\\pages\\summoner.js";
...
var Summoner = function Summoner() {
  ...
  var getleagueFirst = function getleagueFirst(response) {
    return _api_api__WEBPACK_IMPORTED_MODULE_6__["getleagueFirst"](response.id).then(function (response) {
      ...
      return getMatchList(_this.userinfo);
    })["catch"](function (error) {
      return console.log(error);
    });
  };
...
//# sourceMappingURL=summoner.js.8ac7ccde10225cc09977.hot-update.js.map