  ...
  var getMatches = function getMatches(matchesData) {
    matchesData.map(function (v) {
      _api_api__WEBPACK_IMPORTED_MODULE_3__["getmatches"](v.gameId).then(function (response) {
        console.log(matches);
        setMatches(function (oldArray) {
          return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(oldArray), [response.data]);
        });
...
//# sourceMappingURL=summoner.js.7ad782178c27b3c5132c.hot-update.js.map