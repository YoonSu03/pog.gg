...
var Body = function Body(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, leagueEntriesInfo && leagueEntriesInfo.filter(function (data, index) {
    if (data.queueType === "RANKED_SOLO_5x5") {
      return setSoloinfo(data);
    } else if (data.queueType === "RANKED_TFT") {
      return setTftinfo(data);
    } else if (data.queueType === "RANKED_FLEX_SR") {
      return setFlexinfo(data);
    }
...
//# sourceMappingURL=summoner.js.2d0da272dd536141455e.hot-update.js.map