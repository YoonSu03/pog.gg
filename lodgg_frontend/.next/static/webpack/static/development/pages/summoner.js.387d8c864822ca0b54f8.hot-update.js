...
var Leauges = function Leauges(_ref) {
  ...
  return __jsx("div", {
    ...
    gameMinute = (v.gameDuration / 60).toFixed(0);
    console.log((v.gameDuration / 60).toFixed(2) - gameMinute);
    console.log((v.gameDuration / 60).toFixed(0), (v.gameDuration / 60).toFixed(2));
    return __jsx("div", {
      key: i,
...
//# sourceMappingURL=summoner.js.387d8c864822ca0b54f8.hot-update.js.map