...
var Leauges = function Leauges(_ref) {
  ...
  return __jsx("div", {
    ...
    console.log(matchList.matches[i]);
    console.log(v);
    var gamemode = "";
    var gameMinute = 0;
    var gameSecond = 0;
    ...
    var timeStamp = matchList.timestamp;
    var date = new Date(timeStamp);
    console.log(date.getDate); //게임 모드 판별
...
//# sourceMappingURL=summoner.js.008fd9d811e0c14ed579.hot-update.js.map